...
/*initiate the autocomplete function on the "city_input" & "state_input" elements, and pass along the cities & states arrays as possible autocomplete values:*/

autocomplete(document.getElementById("city_input"), cities);
autocomplete(document.getElementById("state_input"), states);

// Add city and state title to replace icon section.
